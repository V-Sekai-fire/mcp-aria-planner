...
defmodule AriaPlannerMcp.Application do
  @moduledoc """
  Application supervisor for Aria Planner MCP Server.
  ...
  def start(_type, _args) do
    ...
    children =
      case transport do
        :http ->
          ...
          [
            {AriaPlannerMcp.HttpServer, [port: port, host: host]}
          ]
        ...
        :stdio ->
          ...
          [
            {AriaPlannerMcp.NativeService, [name: AriaPlannerMcp.NativeService]},
            {AriaPlannerMcp.StdioServer, []}
          ]
      end
    ...
    opts = [
      ...
      name: AriaPlannerMcp.Supervisor,
      max_restarts: 10,
      max_seconds: 60
    ]
