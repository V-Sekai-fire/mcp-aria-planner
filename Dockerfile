...
# Set PATH to include Elixir binaries
ENV PATH="/opt/elixir/bin:${PATH}"

# Copy the release from builder
COPY --from=builder /app/_build/prod/rel/aria_planner_mcp ./aria_planner_mcp
...
# Start the server
CMD ["./aria_planner_mcp/bin/aria_planner_mcp", "start"]
